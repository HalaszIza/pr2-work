...
void Filmek::Kiir()
{
	cout << setw(20) << "Sorozat" << setw(8) << "Evad" << setw(10) << "Epizodok" << setw(8) << "Hossz" << setw(8) << "Ar" << endl;
	for (int i = 0; i < db; i++)
	{
		cout << setw(20) << tmb[i].name << setw(8) << tmb[i].season << setw(10) << tmb[i].episodes << setw(8) << tmb[i].length << setw(8) << tmb[i].price << endl;
	}
}
